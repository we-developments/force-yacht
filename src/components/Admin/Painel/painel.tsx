        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              Aqui será possível conferir as <strong className="font-semibold text-gray-900">Embarcações</strong> ja cadastradas
            </p>
          </div>
                ...
                <tr key={plan.id}>
                  ...
                  >
                    ...
                    <div className="mt-1 flex flex-col text-gray-500 sm:block lg:hidden">
                      <span>
                        {plan.peso} / {plan.tamanho}
                      </span>
                      <span className="hidden sm:inline">·</span>
                      <span>{plan.valor}</span>
                    </div>
                  ...
                  >
                    <div className="sm:hidden">{plan.valor}/mo</div>
                    <div className="hidden sm:block">{plan.valor}/month</div>
                  </td>
                  <td
                    className={classNames(
                      planIdx === 0 ? '' : 'border-t border-transparent',
